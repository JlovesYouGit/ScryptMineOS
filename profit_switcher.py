...
class ProfitSwitchingMiner:
    ...
    def _check_profitability(self) -> dict[str, Any]:
        ...
        # Rough profit estimation (this would be more accurate with real coin
        # prices)
        estimated_daily_revenue = (
            ...
            * 0.001
        )  # $0.001 per MH/s (very rough)  # Add division by zero protection
    ...
    def _should_switch_algorithm(self) -> str | None:
        ...
        while self.running:
            try:
                ...
                if (
                    ...
                    logger.info("Economic status:")
                    logger.info(
                        # Add division by zero protection
                        f"   Hashrate: {profit_data['economic_data']['hashrate'] / 1000:.1f} kH/s"
                    )  # Add division by zero protection
                    logger.info(
