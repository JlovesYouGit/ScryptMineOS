...
class ConfigOptionParser(CustomOptionParser):
    ...
    def check_default(self, option: optparse.Option, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") val: Any) -> Any:
        try:
    ...
    def _get_ordered_configuration_items(
        ...
        for _, value in self.config.items():  # noqa: PERF102
            for section_key, val in value.items():
                ...
                section, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")".", 1)
