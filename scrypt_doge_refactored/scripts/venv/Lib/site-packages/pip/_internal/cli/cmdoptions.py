...
def _handle_config_settings(
    ...
    if sep != "=":
        parser.error(f"Arguments to {opt_str} must be of the form key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")")
...
config_settings: Callable[..., Option] = partial(
    ...
    "Settings take the form key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") Use multiple --config-settings options "
