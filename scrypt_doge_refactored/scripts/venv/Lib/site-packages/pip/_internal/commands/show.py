...
def search_packages_info(query: list[str]) -> Generator[_PackageInfo, None, None]:
    ...
    for query_name in query_names:
        ...
        try:
            ...
            requires = sorted(dist.iter_raw_dependencies(), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")

        try:
            required_by = sorted(_get_requiring_packages(dist), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
        except InvalidRequirement:
            required_by = ["#N/A"]
