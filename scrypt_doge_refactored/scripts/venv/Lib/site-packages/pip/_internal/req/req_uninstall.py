...
def compact(paths: Iterable[str]) -> set[str]:
    ...
    for path in sorted(paths, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
        should_skip = any(
...
def compress_for_rename(paths: Iterable[str]) -> set[str]:
    ...
    unchecked = sorted({os.path.split(p)[0] for p in case_map.values()}, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
