...
class Resolver(BaseResolver):
    ...
    def resolve(
        ...
        for candidate in sorted(
            result.mapping.values(), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") c: c.name != c.project_name
        ):
    ...
    def get_installation_order(
        ...
        sorted_items = sorted(
            ...
            key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") weights=weights),
            reverse=True,
        )
