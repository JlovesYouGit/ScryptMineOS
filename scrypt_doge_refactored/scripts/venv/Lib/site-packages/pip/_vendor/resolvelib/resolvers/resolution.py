...
def _build_result(state: State[RT, CT, KT]) -> Result[RT, CT, KT]:
    ...
    for key, criterion in state.criteria.items():
        ...
        for p in criterion.iter_parent():
            try:
                pkey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
            except KeyError:
                continue
    ...
    def resolve(self, requirements: Iterable[RT], max_rounds: int) -> State[RT, CT, KT]:
        ...
        for round_index in range(max_rounds):
            ...
            if len(narrowed_unstatisfied_names) > 1:
                ...
                name = min(narrowed_unstatisfied_names, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
            else:
...
def _has_route_to_root(
    ...
    key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") | None,
