...
class PygmentsDoc(Directive):
    ...
    def document_lexers_overview(self):
        ...
        for classname, data in sorted(LEXERS.items(), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") x: x[1][1].lower()):
    ...
    def document_lexers(self):
        ...
        modules = {}
        moduledocstrings = {}
        for classname, data in sorted(LEXERS.items(), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") x: x[0]):
            module = data[0]
        ...
        for module, lexers in sorted(modules.items(), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") x: x[0]):
    ...
    def document_formatters(self):
        ...
        out = []
        for classname, data in sorted(FORMATTERS.items(), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") x: x[0]):
            module = data[0]
            mod = __import__(module, None, None, [classname])
            self.filenames.add(mod.__file__)
            cls = getattr(mod, classname)
