...
def loads(__s: str, *, parse_float: ParseFloat = float) -> dict[str, Any]:  # noqa: C901
    ...
    header: key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
...
class Flags:
    ...
    def add_pending(self, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") flag: int) -> None:
    ...
    def unset_all(self, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") -> None:
        cont = self._flags
        for k in key[:-1]:
            if k not in cont:
                return
    ...
    def set(self, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") flag: int, *, recursive: bool) -> None:  # noqa: A003
        cont = self._flags
    ...
    def is_(self, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") flag: int) -> bool:
        if not key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") False  # document root has no flags
        cont = self._flags
        for k in key[:-1]:
            if k not in cont:
                return False
...
class NestedDict:
    ...
    def get_or_create_nest(
        ...
        *,
        ...
        cont: Any = self.dict
        for k in key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") k not in cont:
                cont[k] = {}
            cont = cont[k]
    ...
    def append_nest_to_list(self, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") -> None:
        cont = self.get_or_create_nest(key[:-1])
        last_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
        if last_key in cont:
            list_ = cont[last_key]
...
def create_dict_rule(src: str, pos: Pos, out: Output) -> tuple[Pos, Key]:
    pos += 1  # Skip "["
    pos = skip_chars(src, pos, TOML_WS)
    pos, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") pos)
...
def parse_key(src: str, pos: Pos) -> tuple[Pos, Key]:
    ...
    key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") = (key_part,)
    pos = skip_chars(src, pos, TOML_WS)
    while True:
        try:
            char: str | None = src[pos]
