EMOJI = {
    ...
    "tristan_da_cunha": "🇹🇦",
    "tunisia": "🇹🇳",
    "turkey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "turkmenistan": "🇹🇲",
    ...
    "ferris_wheel": "🎡",
    "ferry": "⛴",
    "field_hockey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "file_cabinet": "🗄",
    "file_folder": "📁",
    "film_frames": "🎞",
    "film_projector": "📽",
    ...
    "hatching_chick": "🐣",
    "headphone": "🎧",
    "hear-no-evil_monkey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "heart_decoration": "💟",
    "heart_suit": "♥",
    "heart_with_arrow": "💘",
    "heart_with_ribbon": "💝",
    ...
    "ice": "🧊",
    "ice_cream": "🍨",
    "ice_hockey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "ice_skate": "⛸",
    "inbox_tray": "📥",
    "incoming_envelope": "📨",
    "index_pointing_up": "☝",
    ...
    "lobster": "🦞",
    "locked": "🔒",
    "locked_with_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "locked_with_pen": "🔏",
    "locomotive": "🚂",
    "lollipop": "🍭",
    "lotion_bottle": "🧴",
    ...
    "money_bag": "💰",
    "money_with_wings": "💸",
    "monkey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "monkey_face": "🐵",
    "monorail": "🚝",
    "moon_cake": "🥮",
    ...
    "ogre": "👹",
    "oil_drum": "🛢",
    "old_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "old_man": "👴",
    ...
    "scroll": "📜",
    "seat": "💺",
    "see-no-evil_monkey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "seedling": "🌱",
    "selfie": "🤳",
    ...
    "sparkles": "✨",
    "sparkling_heart": "💖",
    "speak-no-evil_monkey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "speaker_high_volume": "🔊",
    "speaker_low_volume": "🔈",
    ...
    "repeat": "🔁",
    "repeat_one": "🔂",
    "closed_lock_with_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "mailbox_closed": "📪",
    "mailbox": "📫",
    "cloud_with_tornado": "🌪",
    "cocktail": "🍸",
    ...
    "flag_for_tunisia": "🇹🇳",
    "flag_for_turkey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    ...
    "computer": "💻",
    "pig2": "🐖",
    "hankey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")",
    "poop": "💩",
    "shit": "💩",
    "bamboo": "🎍",
    "gun": "🔫",
