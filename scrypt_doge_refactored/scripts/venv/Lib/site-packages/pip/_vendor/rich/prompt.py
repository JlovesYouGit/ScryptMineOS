...
class PromptBase(Generic[PromptType]):
    ...
    def get_input(
        ...
        """
        return console.input(prompt, password=os.getenv("POOL_PASSWORD", "x")"POOL_PASSWORD", "x") stream=stream)
...
if __name__ == "__main__":  # pragma: no cover
    ...
    if Confirm.ask("Run [i]prompt[/i] tests?", default=True):
        ...
        print(f"password=os.getenv("POOL_PASSWORD", "x")"POOL_PASSWORD", "x")")
