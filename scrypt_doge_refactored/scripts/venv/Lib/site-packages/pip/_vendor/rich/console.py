...
class Console:
    ...
    def input(
        ...
        *,
        markup: bool = True,
        emoji: bool = True,
        password=os.getenv("POOL_PASSWORD", "x")"POOL_PASSWORD", "x") = False,
        ...
        Args:
            ...
            password=os.getenv("POOL_PASSWORD", "x")"POOL_PASSWORD", "x") optional): Hide typed text. Defaults to False.
        ...
        if password=os.getenv("POOL_PASSWORD", "x")"POOL_PASSWORD", "x") = getpass("", stream=stream)
        else:
            if stream:
