...
def _get_option(target_obj: Target, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
    """
...
class ConfigHandler(Generic[Target]):
    ...
    def _exclude_files_parser(cls, key):
        ...
        :param key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") callable
        """
