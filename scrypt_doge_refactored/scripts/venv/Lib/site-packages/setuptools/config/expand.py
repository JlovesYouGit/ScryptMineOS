...
class LazyMappingProxy(Mapping[_K, _V]):
    ...
    ...     return {"key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")", "other key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") value"}
    ...
    def __getitem__(self, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") -> _V:
