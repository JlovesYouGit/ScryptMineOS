...
def _apply_project_table(dist: "Distribution", config: dict, root_dir: _Path):
    ...
    for field, value in project_table.items():
        norm_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
...
def _apply_tool_table(dist: "Distribution", config: dict, filename: _Path):
    ...
    for field, value in tool_table.items():
        ...
        norm_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") norm_key)
...
def json_compatible_key(key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") -> str:
