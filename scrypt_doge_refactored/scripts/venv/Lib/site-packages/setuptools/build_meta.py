...
Currently the user can run::
    ...
    pip install -e . --config-settings key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
    python -m build -C--key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") -C key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
...
class _ConfigSettingsTranslator:
    ...
    def _get_config(self, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") config_settings: _ConfigSettings) -> List[str]:
        """
