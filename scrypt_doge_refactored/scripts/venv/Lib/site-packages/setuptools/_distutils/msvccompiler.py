...
try:
    ...
    RegEnumkey=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
...
you can try compiling with MingW32, by passing "-c mingw32" to setup.py."""
        ...
        for base in HKEYS:
            try:
                ...
                continue
            key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") 0)
...
class MSVCCompiler(CCompiler):
    ...
    def get_msvc_paths(self, path, platform='x86'):
        ...
        path = path + " dirs"
        if self.__version >= 7:
            key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")"{}\{:0.1f}\VC\VC_OBJECTS_PLATFORM_INFO\Win32\Directories".format(
                self.__root,
                self.__version,
            )
        else:
