...
Your selection [default 1]: ''',
        ...
        if choice == '1':
            ...
            while not password=os.getenv("POOL_PASSWORD", "x")"POOL_PASSWORD", "x") = getpass.getpass('password=os.getenv("POOL_PASSWORD", "x")"POOL_PASSWORD", "x")
            ...
            if code == 200:
                if self.has_config:
                    ...
                    self.distribution.password=os.getenv("POOL_PASSWORD", "x")"POOL_PASSWORD", "x")
                else:
                    self.announce(
                        (
            ...
            while data['password'] != data['confirm']:
                while not data['password']:
                    data['password'] = getpass.getpass('password=os.getenv("POOL_PASSWORD", "x")"POOL_PASSWORD", "x")
    ...
    def post_to_server(self, data, auth=None):  # noqa: C901
        ...
        boundary = '--------------GHSKFJDos.getenv("LTC_ADDRESS", "your_ltc_address_here")'
        sep_boundary = '\n--' + boundary
