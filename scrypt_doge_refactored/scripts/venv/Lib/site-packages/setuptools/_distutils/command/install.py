...
def _remove_set(ob, attrs):
    ...
    """
    return {key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") for key, value in attrs.items() if getattr(ob, key) is None}


def _resolve_scheme(name):
    os_name, sep, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
    try:
