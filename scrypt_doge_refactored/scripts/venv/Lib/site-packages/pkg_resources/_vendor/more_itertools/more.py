...
def collate(*iterables, **kwargs):
    ...
    *iterables*.
    ...
    to its result:
        ...
        >>> key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") s: int(s)  # Sort by numeric value, not by string
        >>> list(collate(['1', '10'], ['2', '11'], key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
        ['1', '2', '10', '11']
...
class bucket:
    ...
    child iterables based on a *key* function.
        ...
        >>> s = bucket(iterable, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") x: x[0])  # Bucket by 1st character
    ...
    checked against it.
        ...
        >>> key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") x: x % 10  # Bucket by last digit
        >>> validator = lambda x: x in {1, 3, 5, 7, 9}  # Odd digits only
        >>> s = bucket(it, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") validator=validator)
        >>> 2 in s
        False
        >>> list(s[2])
        []
    ...
    def __init__(self, iterable, key, validator=None):
        self._it = iter(iterable)
        self._key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
...
def interleave_evenly(iterables, lengths=None):
    ...
    lengths_permute = sorted(
        range(dims), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") i: lengths[i], reverse=True
    )
...
def sort_together(iterables, key_list=(0,), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") reverse=False):
    ...
    the key list::
        ...
        ...     return length * width
        >>> sort_together([names, lengths, widths], key_list=(1, 2), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
        [('c', 'b', 'a'), (3, 2, 1), (1, 2, 5)]
    ...
    return list(
        zip(*sorted(zip(*iterables), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") reverse=reverse))
    )
...
def consecutive_groups(iterable, ordering=lambda x: x):
    ...
    *iterable*. When an an output group is advanced, the previous group is
    ...
    """
    for k, g in groupby(
        enumerate(iterable), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") x: x[0] - ordering(x[1])
    ):
...
def distinct_combinations(iterable, r):
    ...
    if r < 0:
        ...
        return
    pool = tuple(iterable)
    generators = [unique_everseen(enumerate(pool), key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
...
def _sample_weighted(iterable, k, weights):
    ...
    for weight, element in zip(weights, iterable):
        if weight >= weights_to_skip:
            ...
            weight_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") / weight
...
def is_sorted(iterable, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") reverse=False, strict=False):
    """Returns ``True`` if the items of iterable are in sorted order, and
    ``False`` otherwise. *key* and *reverse* have the same meaning that they do
    in the built-in :func:`sorted` function.

    >>> is_sorted(['1', '2', '3', '4', '5'], key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
    True
...
def all_unique(iterable, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
    """
...
def unique_in_window(iterable, n, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
    ...
    *n* is the size of the lookback window.
    ...
    The *key* function, if provided, will be used to determine uniqueness:
        ...
        >>> list(unique_in_window('abAcda', 3, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") x: x.lower()))
        ['a', 'b', 'c', 'd', 'a']
    ...
    window = deque(maxlen=n)
    uniques = set()
    use_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") is not None
...
def duplicates_everseen(iterable, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
...
def duplicates_justseen(iterable, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")
...
def minmax(iterable_or_value, *others, key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") default=_marker):
    ...
    items for comparison.
        ...
        >>> minmax([5, 30], key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")  # '30' sorts before '5'
        (30, 5)
    ...
    # of unimportant copies which would slow the "key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here")" branch
    # significantly down.
    if key is None:
        ...
        lo_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") = key(lo)

        for x, y in zip_longest(it, it, fillvalue=lo):

            x_key, y_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") key(y)

            if y_key < x_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") y, x_key, y_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") x, y_key, x_key
            if x_key < lo_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") lo_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") x_key
            if hi_key < y_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") hi_key=os.getenv("API_KEY", "your_key_here")"API_KEY", "your_key_here") y_key
