...
echo cd /d "%~dp0" >> start_miner.bat
echo call venv\Scripts\activate.bat >> start_miner.bat
echo python main.py >> start_miner.bat
echo echo. >> start_miner.bat
echo echo Press any key to exit... >> start_miner.bat
echo pause ^>nul >> start_miner.bat
...
echo.
echo To start the miner, run: start_miner.bat
echo.
pause